...
var zen_settings = {
	...
	'html': {
		...
		'abbreviations': {
			...
			// movable type
            'mtactstr': '<mt:ActionStreams></mt:ActionStreams>',
            'mtacts': '<mt:Actions></mt:Actions>',
            'mtactscom': '<mt:ActionsComment></mt:ActionsComment>',
            'mtactsent': '<mt:ActionsEntry></mt:ActionsEntry>',
            'mtactsfav': '<mt:ActionsFavorite></mt:ActionsFavorite>',
            'mtactsfoo': '<mt:ActionsFooter></mt:ActionsFooter>',
            'mtactshea': '<mt:ActionsHeader></mt:ActionsHeader>',
            'mtadmcgipat': '<mt:AdminCGIPath />',
            'mtadmscr': '<mt:AdminScript />',
            'mtappactbar': '<mt:App:ActionBar />',
            'mtappfor': '<mt:App:Form></mt:App:Form>',
            'mtapplin': '<mt:App:Link />',
            'mtapplisfil': '<mt:App:ListFilters />',
            'mtapplising': '<mt:App:Listing></mt:App:Listing>',
            'mtapppagacts': '<mt:App:PageActions />',
            'mtappset': '<mt:App:Setting></mt:App:Setting>',
            'mtappsetgro': '<mt:App:SettingGroup></mt:App:SettingGroup>',
            'mtappstamsg': '<mt:App:StatusMsg></mt:App:StatusMsg>',
            'mtappwid': '<mt:App:Widget></mt:App:Widget>',
            'mtarccat': '<mt:ArchiveCategory />',
            'mtarccou': '<mt:ArchiveCount />',
            'mtarcdat': '<mt:ArchiveDate />',
            'mtarcdatend': '<mt:ArchiveDateEnd />',
            'mtarcfil': '<mt:ArchiveFile />',
            'mtarclab': '<mt:ArchiveLabel />',
            'mtarclin': '<mt:ArchiveLink />',
            'mtarclis': '<mt:ArchiveList></mt:ArchiveList>',
            'mtarclisfoo': '<mt:ArchiveListFooter></mt:ArchiveListFooter>',
            'mtarclishea': '<mt:ArchiveListHeader></mt:ArchiveListHeader>',
            'mtarcnex': '<mt:ArchiveNext></mt:ArchiveNext>',
            'mtarcpre': '<mt:ArchivePrevious></mt:ArchivePrevious>',
            'mtarctit': '<mt:ArchiveTitle />',
            'mtarctyp': '<mt:ArchiveType />',
            'mtarctyplab': '<mt:ArchiveTypeLabel />',
            'mtarcs': '<mt:Archives></mt:Archives>',
            'mtass': '<mt:Asset></mt:Asset>',
            'mtassaddby': '<mt:AssetAddedBy />',
            'mtasscou': '<mt:AssetCount />',
            'mtassdatadd': '<mt:AssetDateAdded />',
            'mtassdes': '<mt:AssetDescription />',
            'mtassfilext': '<mt:AssetFileExt />',
            'mtassfilnam': '<mt:AssetFileName />',
            'mtassfilpat': '<mt:AssetFilePath />',
            'mtassid': '<mt:AssetID />',
            'mtassiftagged': '<mt:AssetIfTagged></mt:AssetIfTagged>',
            'mtassisfirinrow': '<mt:AssetIsFirstInRow></mt:AssetIsFirstInRow>',
            'mtassislasinrow': '<mt:AssetIsLastInRow></mt:AssetIsLastInRow>',
            'mtasslab': '<mt:AssetLabel />',
            'mtasslin': '<mt:AssetLink />',
            'mtassmintyp': '<mt:AssetMimeType />',
            'mtasspro': '<mt:AssetProperty />',
            'mtassran': '<mt:AssetRank />',
            'mtasssco': '<mt:AssetScore />',
            'mtassscoavg': '<mt:AssetScoreAvg />',
            'mtassscocou': '<mt:AssetScoreCount />',
            'mtassscohig': '<mt:AssetScoreHigh />',
            'mtassscolow': '<mt:AssetScoreLow />',
            'mtasstags': '<mt:AssetTags></mt:AssetTags>',
            'mtassthulin': '<mt:AssetThumbnailLink />',
            'mtassthuurl': '<mt:AssetThumbnailURL />',
            'mtasstyp': '<mt:AssetType />',
            'mtassurl': '<mt:AssetURL />',
            'mtasss': '<mt:Assets></mt:Assets>',
            'mtasssfoo': '<mt:AssetsFooter></mt:AssetsFooter>',
            'mtassshea': '<mt:AssetsHeader></mt:AssetsHeader>',
            'mtatoscr': '<mt:AtomScript />',
            'mtaudcusdes': '<mt:AudioCustomFieldDescription />',
            'mtaudcusnam': '<mt:AudioCustomFieldName />',
            'mtaudcusval': '<mt:AudioCustomFieldValue />',
            'mtaudcuss': '<mt:AudioCustomFields></mt:AudioCustomFields>',
            'mtautauticourl': '<mt:AuthorAuthIconURL />',
            'mtautauttyp': '<mt:AuthorAuthType />',
            'mtautbas': '<mt:AuthorBasename />',
            'mtautcomcou': '<mt:AuthorCommentCount />',
            'mtautcomres': '<mt:AuthorCommentResponses></mt:AuthorCommentResponses>',
            'mtautcoms': '<mt:AuthorComments></mt:AuthorComments>',
            'mtautcusdes': '<mt:AuthorCustomFieldDescription />',
            'mtautcusnam': '<mt:AuthorCustomFieldName />',
            'mtautcusval': '<mt:AuthorCustomFieldValue />',
            'mtautcuss': '<mt:AuthorCustomFields></mt:AuthorCustomFields>',
            'mtautdisnam': '<mt:AuthorDisplayName />',
            'mtautema': '<mt:AuthorEmail />',
            'mtautentscou': '<mt:AuthorEntriesCount />',
            'mtautentcou': '<mt:AuthorEntryCount />',
            'mtautfollin': '<mt:AuthorFollowLink />',
            'mtautfolers': '<mt:AuthorFollowers></mt:AuthorFollowers>',
            'mtautfolerscou': '<mt:AuthorFollowersCount />',
            'mtautfol': '<mt:AuthorFollowing></mt:AuthorFollowing>',
            'mtautfolcoms': '<mt:AuthorFollowingComments></mt:AuthorFollowingComments>',
            'mtautfolcou': '<mt:AuthorFollowingCount />',
            'mtautfolents': '<mt:AuthorFollowingEntries></mt:AuthorFollowingEntries>',
            'mtautfolfav': '<mt:AuthorFollowingFavorites></mt:AuthorFollowingFavorites>',
            'mtauthasent': '<mt:AuthorHasEntry></mt:AuthorHasEntry>',
            'mtauthaspag': '<mt:AuthorHasPage></mt:AuthorHasPage>',
            'mtautid': '<mt:AuthorID />',
            'mtautiffoled': '<mt:AuthorIfFollowed></mt:AuthorIfFollowed>',
            'mtautiffol': '<mt:AuthorIfFollowing></mt:AuthorIfFollowing>',
            'mtautnam': '<mt:AuthorName />',
            'mtautnex': '<mt:AuthorNext></mt:AuthorNext>',
            'mtautpre': '<mt:AuthorPrevious></mt:AuthorPrevious>',
            'mtautran': '<mt:AuthorRank />',
            'mtautsco': '<mt:AuthorScore />',
            'mtautscoavg': '<mt:AuthorScoreAvg />',
            'mtautscocou': '<mt:AuthorScoreCount />',
            'mtautscohig': '<mt:AuthorScoreHigh />',
            'mtautscolow': '<mt:AuthorScoreLow />',
            'mtauturl': '<mt:AuthorURL />',
            'mtautunfollin': '<mt:AuthorUnFollowLink />',
            'mtautusepic': '<mt:AuthorUserpic />',
            'mtautusepicass': '<mt:AuthorUserpicAsset></mt:AuthorUserpicAsset>',
            'mtautusepicurl': '<mt:AuthorUserpicURL />',
            'mtauts': '<mt:Authors></mt:Authors>',
            'mtbloarcurl': '<mt:BlogArchiveURL />',
            'mtblocclima': '<mt:BlogCCLicenseImage />',
            'mtblocclurl': '<mt:BlogCCLicenseURL />',
            'mtblocatcou': '<mt:BlogCategoryCount />',
            'mtblocomcou': '<mt:BlogCommentCount />',
            'mtblocusdes': '<mt:BlogCustomFieldDescription />',
            'mtblocusnam': '<mt:BlogCustomFieldName />',
            'mtblocusval': '<mt:BlogCustomFieldValue />',
            'mtblocuss': '<mt:BlogCustomFields></mt:BlogCustomFields>',
            'mtblodes': '<mt:BlogDescription />',
            'mtbloentcou': '<mt:BlogEntryCount />',
            'mtblofilext': '<mt:BlogFileExtension />',
            'mtblohos': '<mt:BlogHost />',
            'mtbloid': '<mt:BlogID />',
            'mtbloifccl': '<mt:BlogIfCCLicense></mt:BlogIfCCLicense>',
            'mtbloifcomsope': '<mt:BlogIfCommentsOpen></mt:BlogIfCommentsOpen>',
            'mtblolan': '<mt:BlogLanguage />',
            'mtblonam': '<mt:BlogName />',
            'mtblopagcou': '<mt:BlogPageCount />',
            'mtbloparweb': '<mt:BlogParentWebsite></mt:BlogParentWebsite>',
            'mtblopincou': '<mt:BlogPingCount />',
            'mtblorelurl': '<mt:BlogRelativeURL />',
            'mtbloresfoo': '<mt:BlogResultFooter></mt:BlogResultFooter>',
            'mtbloreshea': '<mt:BlogResultHeader></mt:BlogResultHeader>',
            'mtblositpat': '<mt:BlogSitePath />',
            'mtblotemsetid': '<mt:BlogTemplateSetID />',
            'mtblotheid': '<mt:BlogThemeID />',
            'mtblotim': '<mt:BlogTimezone />',
            'mtblourl': '<mt:BlogURL />',
            'mtblos': '<mt:Blogs></mt:Blogs>',
            'mtbuitemid': '<mt:BuildTemplateID />',
            'mtcclrdf': '<mt:CCLicenseRDF />',
            'mtcgihos': '<mt:CGIHost />',
            'mtcgipat': '<mt:CGIPath />',
            'mtcgirelurl': '<mt:CGIRelativeURL />',
            'mtcgiserpat': '<mt:CGIServerPath />',
            'mtcal': '<mt:Calendar></mt:Calendar>',
            'mtcalcelnum': '<mt:CalendarCellNumber />',
            'mtcaldat': '<mt:CalendarDate />',
            'mtcalday': '<mt:CalendarDay />',
            'mtcalifbla': '<mt:CalendarIfBlank></mt:CalendarIfBlank>',
            'mtcalifents': '<mt:CalendarIfEntries></mt:CalendarIfEntries>',
            'mtcalifnoents': '<mt:CalendarIfNoEntries></mt:CalendarIfNoEntries>',
            'mtcaliftod': '<mt:CalendarIfToday></mt:CalendarIfToday>',
            'mtcalweefoo': '<mt:CalendarWeekFooter></mt:CalendarWeekFooter>',
            'mtcalweehea': '<mt:CalendarWeekHeader></mt:CalendarWeekHeader>',
            'mtcapfie': '<mt:CaptchaFields />',
            'mtcats': '<mt:Categories></mt:Categories>',
            'mtcatarclin': '<mt:CategoryArchiveLink />',
            'mtcatbas': '<mt:CategoryBasename />',
            'mtcatcomcou': '<mt:CategoryCommentCount />',
            'mtcatcou': '<mt:CategoryCount />',
            'mtcatcusdes': '<mt:CategoryCustomFieldDescription />',
            'mtcatcusnam': '<mt:CategoryCustomFieldName />',
            'mtcatcusval': '<mt:CategoryCustomFieldValue />',
            'mtcatcuss': '<mt:CategoryCustomFields />',
            'mtcatdes': '<mt:CategoryDescription />',
            'mtcatid': '<mt:CategoryID />',
            'mtcatifallpins': '<mt:CategoryIfAllowPings></mt:CategoryIfAllowPings>',
            'mtcatlab': '<mt:CategoryLabel />',
            'mtcatnex': '<mt:CategoryNext></mt:CategoryNext>',
            'mtcatpre': '<mt:CategoryPrevious></mt:CategoryPrevious>',
            'mtcattracou': '<mt:CategoryTrackbackCount />',
            'mtcattralin': '<mt:CategoryTrackbackLink />',
            'mtcomaut': '<mt:CommentAuthor />',
            'mtcomautide': '<mt:CommentAuthorIdentity />',
            'mtcomautlin': '<mt:CommentAuthorLink />',
            'mtcombloid': '<mt:CommentBlogID />',
            'mtcombod': '<mt:CommentBody />',
            'mtcomcusdes': '<mt:CommentCustomFieldDescription />',
            'mtcomcusnam': '<mt:CommentCustomFieldName />',
            'mtcomcusval': '<mt:CommentCustomFieldValue />',
            'mtcomcuss': '<mt:CommentCustomFields></mt:CommentCustomFields>',
            'mtcomdat': '<mt:CommentDate />',
            'mtcomema': '<mt:CommentEmail />',
            'mtcoment': '<mt:CommentEntry></mt:CommentEntry>',
            'mtcomentid': '<mt:CommentEntryID />',
            'mtcomid': '<mt:CommentID />',
            'mtcomip': '<mt:CommentIP />',
            'mtcomifmod': '<mt:CommentIfModerated></mt:CommentIfModerated>',
            'mtcomlin': '<mt:CommentLink />',
            'mtcomnam': '<mt:CommentName />',
            'mtcomordnum': '<mt:CommentOrderNumber />',
            'mtcompar': '<mt:CommentParent></mt:CommentParent>',
            'mtcomparid': '<mt:CommentParentID />',
            'mtcompreaut': '<mt:CommentPreviewAuthor />',
            'mtcompreautlin': '<mt:CommentPreviewAuthorLink />',
            'mtcomprebod': '<mt:CommentPreviewBody />',
            'mtcompredat': '<mt:CommentPreviewDate />',
            'mtcompreema': '<mt:CommentPreviewEmail />',
            'mtcompreip': '<mt:CommentPreviewIP />',
            'mtcompreissta': '<mt:CommentPreviewIsStatic />',
            'mtcompreurl': '<mt:CommentPreviewURL />',
            'mtcomran': '<mt:CommentRank />',
            'mtcomrep': '<mt:CommentReplies></mt:CommentReplies>',
            'mtcomreprec': '<mt:CommentRepliesRecurse />',
            'mtcomsco': '<mt:CommentScore />',
            'mtcomscoavg': '<mt:CommentScoreAvg />',
            'mtcomscocou': '<mt:CommentScoreCount />',
            'mtcomscohig': '<mt:CommentScoreHigh />',
            'mtcomscolow': '<mt:CommentScoreLow />',
            'mtcomscr': '<mt:CommentScript />',
            'mtcomurl': '<mt:CommentURL />',
            'mtcomerauticourl': '<mt:CommenterAuthIconURL />',
            'mtcomerauttyp': '<mt:CommenterAuthType />',
            'mtcomerema': '<mt:CommenterEmail />',
            'mtcomerid': '<mt:CommenterID />',
            'mtcomeriftru': '<mt:CommenterIfTrusted></mt:CommenterIfTrusted>',
            'mtcomernam': '<mt:CommenterName />',
            'mtcomernamthu': '<mt:CommenterNameThunk />',
            'mtcomerurl': '<mt:CommenterURL />',
            'mtcomerusename': '<mt:CommenterUsername />',
            'mtcomerusepic': '<mt:CommenterUserpic />',
            'mtcomerusepicass': '<mt:CommenterUserpicAsset></mt:CommenterUserpicAsset>',
            'mtcomerusepicurl': '<mt:CommenterUserpicURL />',
            'mtcoms': '<mt:Comments></mt:Comments>',
            'mtcomsfoo': '<mt:CommentsFooter></mt:CommentsFooter>',
            'mtcomshea': '<mt:CommentsHeader></mt:CommentsHeader>',
            'mtcommscr': '<mt:CommunityScript />',
            'mtconfil': '<mt:ConfigFile />',
            'mtcurpag': '<mt:CurrentPage />',
            'mtcusbas': '<mt:CustomFieldBasename />',
            'mtcusdes': '<mt:CustomFieldDescription />',
            'mtcusthm': '<mt:CustomFieldHTML />',
            'mtcusisreq': '<mt:CustomFieldIsRequired />',
            'mtcusnam': '<mt:CustomFieldName />',
            'mtcusval': '<mt:CustomFieldValue />',
            'mtdate': '<mt:Date />',
            'mtdatefoo': '<mt:DateFooter></mt:DateFooter>',
            'mtdatehea': '<mt:DateHeader></mt:DateHeader>',
            'mtdeflan': '<mt:DefaultLanguage />',
            'mtels': '<mt:Else></mt:Else>',
            'mtelsif': '<mt:ElseIf></mt:ElseIf>',
            'mtents': '<mt:Entries></mt:Entries>',
            'mtentscou': '<mt:EntriesCount />',
            'mtentsfoo': '<mt:EntriesFooter></mt:EntriesFooter>',
            'mtentshea': '<mt:EntriesHeader></mt:EntriesHeader>',
            'mtentswitsubcats': '<mt:EntriesWithSubCategories></mt:EntriesWithSubCategories>',
            'mtentaddcats': '<mt:EntryAdditionalCategories></mt:EntryAdditionalCategories>',
            'mtentasss': '<mt:EntryAssets></mt:EntryAssets>',
            'mtentatoid': '<mt:EntryAtomID />',
            'mtentaud': '<mt:EntryAudio />',
            'mtentaut': '<mt:EntryAuthor />',
            'mtentautdisnam': '<mt:EntryAuthorDisplayName />',
            'mtentautema': '<mt:EntryAuthorEmail />',
            'mtentautid': '<mt:EntryAuthorID />',
            'mtentautlin': '<mt:EntryAuthorLink />',
            'mtentautnic': '<mt:EntryAuthorNickname />',
            'mtentauturl': '<mt:EntryAuthorURL />',
            'mtentautusename': '<mt:EntryAuthorUsername />',
            'mtentautusepic': '<mt:EntryAuthorUserpic />',
            'mtentautusepicass': '<mt:EntryAuthorUserpicAsset></mt:EntryAuthorUserpicAsset>',
            'mtentautusepicurl': '<mt:EntryAuthorUserpicURL />',
            'mtentbas': '<mt:EntryBasename />',
            'mtentblodes': '<mt:EntryBlogDescription />',
            'mtentbloid': '<mt:EntryBlogID />',
            'mtentblonam': '<mt:EntryBlogName />',
            'mtentblourl': '<mt:EntryBlogURL />',
            'mtentbod': '<mt:EntryBody />',
            'mtentcats': '<mt:EntryCategories></mt:EntryCategories>',
            'mtentcat': '<mt:EntryCategory />',
            'mtentcla': '<mt:EntryClass />',
            'mtentclalab': '<mt:EntryClassLabel />',
            'mtentcomcou': '<mt:EntryCommentCount />',
            'mtentcreddat': '<mt:EntryCreatedDate />',
            'mtentcusdes': '<mt:EntryCustomFieldDescription />',
            'mtentcusnam': '<mt:EntryCustomFieldName />',
            'mtentcusval': '<mt:EntryCustomFieldValue />',
            'mtentcuss': '<mt:EntryCustomFields></mt:EntryCustomFields>',
            'mtentdat': '<mt:EntryDate />',
            'mtentedilin': '<mt:EntryEditLink />',
            'mtentembcod': '<mt:EntryEmbedCode />',
            'mtentexc': '<mt:EntryExcerpt />',
            'mtentfla': '<mt:EntryFlag />',
            'mtentid': '<mt:EntryID />',
            'mtentifallcoms': '<mt:EntryIfAllowComments></mt:EntryIfAllowComments>',
            'mtentifallpins': '<mt:EntryIfAllowPings></mt:EntryIfAllowPings>',
            'mtentifcat': '<mt:EntryIfCategory></mt:EntryIfCategory>',
            'mtentifcomsope': '<mt:EntryIfCommentsOpen></mt:EntryIfCommentsOpen>',
            'mtentifext': '<mt:EntryIfExtended></mt:EntryIfExtended>',
            'mtentiftagged': '<mt:EntryIfTagged></mt:EntryIfTagged>',
            'mtentkey': '<mt:EntryKeywords />',
            'mtentlin': '<mt:EntryLink />',
            'mtentlinurl': '<mt:EntryLinkURL />',
            'mtentmoddat': '<mt:EntryModifiedDate />',
            'mtentmor': '<mt:EntryMore />',
            'mtentnex': '<mt:EntryNext></mt:EntryNext>',
            'mtentper': '<mt:EntryPermalink />',
            'mtentpho': '<mt:EntryPhoto />',
            'mtentpostyp': '<mt:EntryPostType />',
            'mtentpre': '<mt:EntryPrevious></mt:EntryPrevious>',
            'mtentran': '<mt:EntryRank />',
            'mtentrawpostyp': '<mt:EntryRawPostType />',
            'mtentrecvotlin': '<mt:EntryRecommendVoteLink />',
            'mtentrectot': '<mt:EntryRecommendedTotal />',
            'mtentsco': '<mt:EntryScore />',
            'mtentscoavg': '<mt:EntryScoreAvg />',
            'mtentscocou': '<mt:EntryScoreCount />',
            'mtentscohig': '<mt:EntryScoreHigh />',
            'mtentscolow': '<mt:EntryScoreLow />',
            'mtentsta': '<mt:EntryStatus />',
            'mtenttags': '<mt:EntryTags></mt:EntryTags>',
            'mtenttit': '<mt:EntryTitle />',
            'mtenttracou': '<mt:EntryTrackbackCount />',
            'mtenttradat': '<mt:EntryTrackbackData />',
            'mtenttraid': '<mt:EntryTrackbackID />',
            'mtenttralin': '<mt:EntryTrackbackLink />',
            'mterrmes': '<mt:ErrorMessage />',
            'mtfee': '<mt:Feed></mt:Feed>',
            'mtfeeents': '<mt:FeedEntries></mt:FeedEntries>',
            'mtfeeentlin': '<mt:FeedEntryLink />',
            'mtfeeenttit': '<mt:FeedEntryTitle />',
            'mtfeeinc': '<mt:FeedInclude />',
            'mtfeelin': '<mt:FeedLink />',
            'mtfeetit': '<mt:FeedTitle />',
            'mtfeebacksco': '<mt:FeedbackScore />',
            'mtfilcusdes': '<mt:FileCustomFieldDescription></mt:FileCustomFieldDescription>',
            'mtfilcusnam': '<mt:FileCustomFieldName />',
            'mtfilcusval': '<mt:FileCustomFieldValue />',
            'mtfilcuss': '<mt:FileCustomFields></mt:FileCustomFields>',
            'mtfiltem': '<mt:FileTemplate />',
            'mtfolbas': '<mt:FolderBasename />',
            'mtfolcou': '<mt:FolderCount />',
            'mtfolcusdes': '<mt:FolderCustomFieldDescription />',
            'mtfolcusnam': '<mt:FolderCustomFieldName />',
            'mtfolcusval': '<mt:FolderCustomFieldValue />',
            'mtfolcuss': '<mt:FolderCustomFields></mt:FolderCustomFields>',
            'mtfoldes': '<mt:FolderDescription />',
            'mtfolfoo': '<mt:FolderFooter></mt:FolderFooter>',
            'mtfolhea': '<mt:FolderHeader></mt:FolderHeader>',
            'mtfolid': '<mt:FolderID />',
            'mtfollab': '<mt:FolderLabel />',
            'mtfolnex': '<mt:FolderNext></mt:FolderNext>',
            'mtfolpat': '<mt:FolderPath />',
            'mtfolpre': '<mt:FolderPrevious></mt:FolderPrevious>',
            'mtfols': '<mt:Folders></mt:Folders>',
            'mtfor': '<mt:For></mt:For>',
            'mtget': '<mt:GetVar />',
            'mthtttyp': '<mt:HTTPContentType />',
            'mthasnoparcat': '<mt:HasNoParentCategory></mt:HasNoParentCategory>',
            'mthasnosubcats': '<mt:HasNoSubCategories></mt:HasNoSubCategories>',
            'mthasparcat': '<mt:HasParentCategory></mt:HasParentCategory>',
            'mthasparfol': '<mt:HasParentFolder></mt:HasParentFolder>',
            'mthassubcats': '<mt:HasSubCategories></mt:HasSubCategories>',
            'mthassubfols': '<mt:HasSubFolders></mt:HasSubFolders>',
            'mtif': '<mt:If></mt:If>',
            'mtifallcomhtm': '<mt:IfAllowCommentHTML></mt:IfAllowCommentHTML>',
            'mtifanorecall': '<mt:IfAnonymousRecommendAllowed></mt:IfAnonymousRecommendAllowed>',
            'mtifarctyp': '<mt:IfArchiveType></mt:IfArchiveType>',
            'mtifarctypena': '<mt:IfArchiveTypeEnabled></mt:IfArchiveTypeEnabled>',
            'mtifblo': '<mt:IfBlog></mt:IfBlog>',
            'mtifcat': '<mt:IfCategory></mt:IfCategory>',
            'mtifcompar': '<mt:IfCommentParent></mt:IfCommentParent>',
            'mtifcomrep': '<mt:IfCommentReplies></mt:IfCommentReplies>',
            'mtifcomerisaut': '<mt:IfCommenterIsAuthor></mt:IfCommenterIsAuthor>',
            'mtifcomerisentaut': '<mt:IfCommenterIsEntryAuthor></mt:IfCommenterIsEntryAuthor>',
            'mtifcomertru': '<mt:IfCommenterTrusted></mt:IfCommenterTrusted>',
            'mtifcomsacc': '<mt:IfCommentsAccepted></mt:IfCommentsAccepted>',
            'mtifcomsact': '<mt:IfCommentsActive></mt:IfCommentsActive>',
            'mtifcomsalled': '<mt:IfCommentsAllowed></mt:IfCommentsAllowed>',
            'mtifcomsmod': '<mt:IfCommentsModerated></mt:IfCommentsModerated>',
            'mtifcurpag': '<mt:IfCurrentPage></mt:IfCurrentPage>',
            'mtifdyn': '<mt:IfDynamic></mt:IfDynamic>',
            'mtifentrec': '<mt:IfEntryRecommended />',
            'mtiffol': '<mt:IfFolder></mt:IfFolder>',
            'mtifimasup': '<mt:IfImageSupport></mt:IfImageSupport>',
            'mtifisanc': '<mt:IfIsAncestor></mt:IfIsAncestor>',
            'mtifisdes': '<mt:IfIsDescendant></mt:IfIsDescendant>',
            'mtiflogin': '<mt:IfLoggedIn></mt:IfLoggedIn>',
            'mtifmaxresscutoff': '<mt:IfMaxResultsCutoff></mt:IfMaxResultsCutoff>',
            'mtifmorress': '<mt:IfMoreResults></mt:IfMoreResults>',
            'mtifneeema': '<mt:IfNeedEmail></mt:IfNeedEmail>',
            'mtifnonemp': '<mt:IfNonEmpty></mt:IfNonEmpty>',
            'mtifnonzer': '<mt:IfNonZero></mt:IfNonZero>',
            'mtifpinsacc': '<mt:IfPingsAccepted></mt:IfPingsAccepted>',
            'mtifpinsact': '<mt:IfPingsActive></mt:IfPingsActive>',
            'mtifpinsalled': '<mt:IfPingsAllowed></mt:IfPingsAllowed>',
            'mtifpinsmod': '<mt:IfPingsModerated></mt:IfPingsModerated>',
            'mtifpreress': '<mt:IfPreviousResults></mt:IfPreviousResults>',
            'mtifregalled': '<mt:IfRegistrationAllowed></mt:IfRegistrationAllowed>',
            'mtifregnotreq': '<mt:IfRegistrationNotRequired></mt:IfRegistrationNotRequired>',
            'mtifregreq': '<mt:IfRegistrationRequired></mt:IfRegistrationRequired>',
            'mtifreqcomemas': '<mt:IfRequireCommentEmails></mt:IfRequireCommentEmails>',
            'mtifsta': '<mt:IfStatic></mt:IfStatic>',
            'mtifstrsea': '<mt:IfStraightSearch></mt:IfStraightSearch>',
            'mtiftagsea': '<mt:IfTagSearch></mt:IfTagSearch>',
            'mtiftypkeytok': '<mt:IfTypeKeyToken></mt:IfTypeKeyToken>',
            'mtifweb': '<mt:IfWebsite></mt:IfWebsite>',
            'mtign': '<mt:Ignore></mt:Ignore>',
            'mtimacusdes': '<mt:ImageCustomFieldDescription />',
            'mtimacusnam': '<mt:ImageCustomFieldName />',
            'mtimacusval': '<mt:ImageCustomFieldValue />',
            'mtimacuss': '<mt:ImageCustomFields></mt:ImageCustomFields>',
            'mtimahei': '<mt:ImageHeight />',
            'mtimaurl': '<mt:ImageURL />',
            'mtimawid': '<mt:ImageWidth />',
            'mtinc': '<mt:Include />',
            'mtincblo': '<mt:IncludeBlock></mt:IncludeBlock>',
            'mtindbas': '<mt:IndexBasename />',
            'mtindlin': '<mt:IndexLink />',
            'mtindlis': '<mt:IndexList></mt:IndexList>',
            'mtindnam': '<mt:IndexName />',
            'mtlin': '<mt:Link />',
            'mtloo': '<mt:Loop></mt:Loop>',
            'mtmaropts': '<mt:MarkdownOptions></mt:MarkdownOptions>',
            'mtmaxress': '<mt:MaxResults />',
            'mtmul': '<mt:MultiBlog></mt:MultiBlog>',
            'mtmuliflocblo': '<mt:MultiBlogIfLocalBlog></mt:MultiBlogIfLocalBlog>',
            'mtmullocblo': '<mt:MultiBlogLocalBlog></mt:MultiBlogLocalBlog>',
            'mtnexlin': '<mt:NextLink />',
            'mtnos': '<mt:NoSearch></mt:NoSearch>',
            'mtnosress': '<mt:NoSearchResults></mt:NoSearchResults>',
            'mtnot': '<mt:NotifyScript />',
            'mtothblo': '<mt:OtherBlog></mt:OtherBlog>',
            'mtothprovar': '<mt:OtherProfileVar />',
            'mtothpros': '<mt:OtherProfiles></mt:OtherProfiles>',
            'mtpagasss': '<mt:PageAssets></mt:PageAssets>',
            'mtpagautdisnam': '<mt:PageAuthorDisplayName />',
            'mtpagautema': '<mt:PageAuthorEmail />',
            'mtpagautlin': '<mt:PageAuthorLink />',
            'mtpagauturl': '<mt:PageAuthorURL />',
            'mtpagbas': '<mt:PageBasename />',
            'mtpagbod': '<mt:PageBody />',
            'mtpagcusdes': '<mt:PageCustomFieldDescription />',
            'mtpagcusnam': '<mt:PageCustomFieldName />',
            'mtpagcusval': '<mt:PageCustomFieldValue />',
            'mtpagcuss': '<mt:PageCustomFields></mt:PageCustomFields>',
            'mtpagdat': '<mt:PageDate />',
            'mtpagexc': '<mt:PageExcerpt />',
            'mtpagfol': '<mt:PageFolder></mt:PageFolder>',
            'mtpagid': '<mt:PageID />',
            'mtpagiftagged': '<mt:PageIfTagged></mt:PageIfTagged>',
            'mtpagkey': '<mt:PageKeywords />',
            'mtpagmoddat': '<mt:PageModifiedDate />',
            'mtpagmor': '<mt:PageMore />',
            'mtpagnex': '<mt:PageNext></mt:PageNext>',
            'mtpagper': '<mt:PagePermalink />',
            'mtpagpre': '<mt:PagePrevious></mt:PagePrevious>',
            'mtpagtags': '<mt:PageTags></mt:PageTags>',
            'mtpagtit': '<mt:PageTitle />',
            'mtpagrblo': '<mt:PagerBlock></mt:PagerBlock>',
            'mtpagrlin': '<mt:PagerLink />',
            'mtpags': '<mt:Pages></mt:Pages>',
            'mtpagsfoo': '<mt:PagesFooter></mt:PagesFooter>',
            'mtpagshea': '<mt:PagesHeader></mt:PagesHeader>',
            'mtparcats': '<mt:ParentCategories></mt:ParentCategories>',
            'mtparcat': '<mt:ParentCategory></mt:ParentCategory>',
            'mtparfol': '<mt:ParentFolder></mt:ParentFolder>',
            'mtparfols': '<mt:ParentFolders></mt:ParentFolders>',
            'mtpinblonam': '<mt:PingBlogName />',
            'mtpindat': '<mt:PingDate />',
            'mtpinent': '<mt:PingEntry></mt:PingEntry>',
            'mtpinexc': '<mt:PingExcerpt />',
            'mtpinid': '<mt:PingID />',
            'mtpinip': '<mt:PingIP />',
            'mtpinran': '<mt:PingRank />',
            'mtpinsco': '<mt:PingScore />',
            'mtpinscoavg': '<mt:PingScoreAvg />',
            'mtpinscocou': '<mt:PingScoreCount />',
            'mtpinscohig': '<mt:PingScoreHigh />',
            'mtpinscolow': '<mt:PingScoreLow />',
            'mtpintit': '<mt:PingTitle />',
            'mtpinurl': '<mt:PingURL />',
            'mtpins': '<mt:Pings></mt:Pings>',
            'mtpinsfoo': '<mt:PingsFooter></mt:PingsFooter>',
            'mtpinshea': '<mt:PingsHeader></mt:PingsHeader>',
            'mtpinssen': '<mt:PingsSent></mt:PingsSent>',
            'mtpinssenurl': '<mt:PingsSentURL />',
            'mtprelin': '<mt:PreviousLink />',
            'mtprodnam': '<mt:ProductName />',
            'mtprofsers': '<mt:ProfileServices></mt:ProfileServices>',
            'mtpubcha': '<mt:PublishCharset />',
            'mtremsiginlin': '<mt:RemoteSignInLink />',
            'mtremsigoutlin': '<mt:RemoteSignOutLink />',
            'mtseaincblos': '<mt:SearchIncludeBlogs />',
            'mtseamaxress': '<mt:SearchMaxResults />',
            'mtsearescou': '<mt:SearchResultCount />',
            'mtsearess': '<mt:SearchResults></mt:SearchResults>',
            'mtseascr': '<mt:SearchScript />',
            'mtseastr': '<mt:SearchString />',
            'mtseatemid': '<mt:SearchTemplateID />',
            'mtsec': '<mt:Section></mt:Section>',
            'mthash': '<mt:SetHashVar></mt:SetHashVar>',
            'mtset': '<mt:SetVar />',
            'mtsetblo': '<mt:SetVarBlock></mt:SetVarBlock>',
            'mtsettem': '<mt:SetVarTemplate></mt:SetVarTemplate>',
            'mtsets': '<mt:SetVars></mt:SetVars>',
            'mtsigonurl': '<mt:SignOnURL />',
            'mtsmapanver': '<mt:SmartyPantsVersion />',
            'mtstafilpat': '<mt:StaticFilePath />',
            'mtstawebpat': '<mt:StaticWebPath />',
            'mtstr': '<mt:StreamAction />',
            'mtstrdat': '<mt:StreamActionDate />',
            'mtstrid': '<mt:StreamActionID />',
            'mtstrmoddat': '<mt:StreamActionModifiedDate />',
            'mtstrolup': '<mt:StreamActionRollup></mt:StreamActionRollup>',
            'mtstrtags': '<mt:StreamActionTags></mt:StreamActionTags>',
            'mtstrthuurl': '<mt:StreamActionThumbnailURL />',
            'mtstrtit': '<mt:StreamActionTitle />',
            'mtstrvar': '<mt:StreamActionVar />',
            'mtstrvia': '<mt:StreamActionVia />',
            'mtsubcatisfir': '<mt:SubCatIsFirst></mt:SubCatIsFirst>',
            'mtsubcatislas': '<mt:SubCatIsLast></mt:SubCatIsLast>',
            'mtsubcats': '<mt:SubCategories></mt:SubCategories>',
            'mtsubcatpat': '<mt:SubCategoryPath />',
            'mtsubcatsrec': '<mt:SubCatsRecurse />',
            'mtsubfolrec': '<mt:SubFolderRecurse />',
            'mtsubfols': '<mt:SubFolders></mt:SubFolders>',
            'mtsupdirurl': '<mt:SupportDirectoryURL />',
            'mttagcou': '<mt:TagCount />',
            'mttagid': '<mt:TagID />',
            'mttaglab': '<mt:TagLabel />',
            'mttagnam': '<mt:TagName />',
            'mttagran': '<mt:TagRank />',
            'mttagsealin': '<mt:TagSearchLink />',
            'mttags': '<mt:Tags></mt:Tags>',
            'mttemcredon': '<mt:TemplateCreatedOn />',
            'mttemcusdes': '<mt:TemplateCustomFieldDescription />',
            'mttemcusnam': '<mt:TemplateCustomFieldName />',
            'mttemcusval': '<mt:TemplateCustomFieldValue />',
            'mttemcuss': '<mt:TemplateCustomFields></mt:TemplateCustomFields>',
            'mttemnote': '<mt:TemplateNote />',
            'mttex': '<mt:Textile></mt:Textile>',
            'mttexheaoff': '<mt:TextileHeadOffset />',
            'mttexopts': '<mt:TextileOptions />',
            'mttopcats': '<mt:TopLevelCategories></mt:TopLevelCategories>',
            'mttopfol': '<mt:TopLevelFolder></mt:TopLevelFolder>',
            'mttopfols': '<mt:TopLevelFolders></mt:TopLevelFolders>',
            'mttoppar': '<mt:TopLevelParent></mt:TopLevelParent>',
            'mttotpags': '<mt:TotalPages />',
            'mttrascr': '<mt:TrackbackScript />',
            'mttyptok': '<mt:TypeKeyToken />',
            'mtunl': '<mt:Unless></mt:Unless>',
            'mtvar': '<mt:Var />',
            'mtver': '<mt:Version />',
            'mtvidcusdes': '<mt:VideoCustomFieldDescription />',
            'mtvidcusnam': '<mt:VideoCustomFieldName />',
            'mtvidcusval': '<mt:VideoCustomFieldValue />',
            'mtvidcuss': '<mt:VideoCustomFields></mt:VideoCustomFields>',
            'mtwebcclima': '<mt:WebsiteCCLicenseImage />',
            'mtwebcclurl': '<mt:WebsiteCCLicenseURL />',
            'mtwebcomcou': '<mt:WebsiteCommentCount />',
            'mtwebcusdes': '<mt:WebsiteCustomFieldDescription />',
            'mtwebcusnam': '<mt:WebsiteCustomFieldName />',
            'mtwebcusval': '<mt:WebsiteCustomFieldValue />',
            'mtwebcuss': '<mt:WebsiteCustomFields></mt:WebsiteCustomFields>',
            'mtwebdes': '<mt:WebsiteDescription />',
            'mtwebfilext': '<mt:WebsiteFileExtension />',
            'mtwebhos': '<mt:WebsiteHost />',
            'mtwebid': '<mt:WebsiteID />',
            'mtwebifccl': '<mt:WebsiteIfCCLicense></mt:WebsiteIfCCLicense>',
            'mtwebifcomsope': '<mt:WebsiteIfCommentsOpen></mt:WebsiteIfCommentsOpen>',
            'mtweblan': '<mt:WebsiteLanguage />',
            'mtwebnam': '<mt:WebsiteName />',
            'mtwebpagcou': '<mt:WebsitePageCount />',
            'mtwebpat': '<mt:WebsitePath />',
            'mtwebpincou': '<mt:WebsitePingCount />',
            'mtwebrelurl': '<mt:WebsiteRelativeURL />',
            'mtwebtheid': '<mt:WebsiteThemeID />',
            'mtwebtim': '<mt:WebsiteTimezone />',
            'mtweburl': '<mt:WebsiteURL />',
            'mtwebs': '<mt:Websites></mt:Websites>',
            'mtwidmon': '<mt:WidgetManager />',
            'mtwidset': '<mt:WidgetSet />',
            'mtxmlscr': '<mt:XMLRPCScript />'

		},
		
		'element_types': {
			'empty': 'area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed,keygen,command',
			'block_level': 'address,applet,blockquote,button,center,dd,del,dir,div,dl,dt,fieldset,form,frameset,hr,iframe,ins,isindex,li,link,map,menu,noframes,noscript,object,ol,p,pre,script,table,tbody,td,tfoot,th,thead,tr,ul,h1,h2,h3,h4,h5,h6,mt:ActionStreams,mt:Actions,mt:ActionsComment,mt:ActionsEntry,mt:ActionsFavorite,mt:ActionsFooter,mt:ActionsHeader,mt:App:Form,mt:App:Listing,mt:App:Setting,mt:App:SettingGroup,mt:App:StatusMsg,mt:App:Widget,mt:ArchiveList,mt:ArchiveListFooter,mt:ArchiveListHeader,mt:ArchiveNext,mt:ArchivePrevious,mt:Archives,mt:Asset,mt:AssetIfTagged,mt:AssetIsFirstInRow,mt:AssetIsLastInRow,mt:AssetTags,mt:Assets,mt:AssetsFooter,mt:AssetsHeader,mt:AudioCustomFields,mt:AuthorCommentResponses,mt:AuthorComments,mt:AuthorCustomFields,mt:AuthorFollowers,mt:AuthorFollowing,mt:AuthorFollowingComments,mt:AuthorFollowingEntries,mt:AuthorFollowingFavorites,mt:AuthorHasEntry,mt:AuthorHasPage,mt:AuthorIfFollowed,mt:AuthorIfFollowing,mt:AuthorNext,mt:AuthorPrevious,mt:AuthorUserpicAsset,mt:Authors,mt:BlogCustomFields,mt:BlogIfCCLicense,mt:BlogIfCommentsOpen,mt:BlogParentWebsite,mt:BlogResultFooter,mt:BlogResultHeader,mt:Blogs,mt:Calendar,mt:CalendarIfBlank,mt:CalendarIfEntries,mt:CalendarIfNoEntries,mt:CalendarIfToday,mt:CalendarWeekFooter,mt:CalendarWeekHeader,mt:Categories,mt:CategoryIfAllowPings,mt:CategoryNext,mt:CategoryPrevious,mt:CommentCustomFields,mt:CommentEntry,mt:CommentIfModerated,mt:CommentParent,mt:CommentReplies,mt:CommenterIfTrusted,mt:CommenterUserpicAsset,mt:Comments,mt:CommentsFooter,mt:CommentsHeader,mt:DateFooter,mt:DateHeader,mt:Else,mt:ElseIf,mt:Entries,mt:EntriesFooter,mt:EntriesHeader,mt:EntriesWithSubCategories,mt:EntryAdditionalCategories,mt:EntryAssets,mt:EntryAuthorUserpicAsset,mt:EntryCategories,mt:EntryCustomFields,mt:EntryIfAllowComments,mt:EntryIfAllowPings,mt:EntryIfCategory,mt:EntryIfCommentsOpen,mt:EntryIfExtended,mt:EntryIfTagged,mt:EntryNext,mt:EntryPrevious,mt:EntryTags,mt:Feed,mt:FeedEntries,mt:FileCustomFieldDescription,mt:FileCustomFields,mt:FolderCustomFields,mt:FolderFooter,mt:FolderHeader,mt:FolderNext,mt:FolderPrevious,mt:Folders,mt:For,mt:HasNoParentCategory,mt:HasNoSubCategories,mt:HasParentCategory,mt:HasParentFolder,mt:HasSubCategories,mt:HasSubFolders,mt:If,mt:IfAllowCommentHTML,mt:IfAnonymousRecommendAllowed,mt:IfArchiveType,mt:IfArchiveTypeEnabled,mt:IfBlog,mt:IfCategory,mt:IfCommentParent,mt:IfCommentReplies,mt:IfCommenterIsAuthor,mt:IfCommenterIsEntryAuthor,mt:IfCommenterTrusted,mt:IfCommentsAccepted,mt:IfCommentsActive,mt:IfCommentsAllowed,mt:IfCommentsModerated,mt:IfCurrentPage,mt:IfDynamic,mt:IfFolder,mt:IfImageSupport,mt:IfIsAncestor,mt:IfIsDescendant,mt:IfLoggedIn,mt:IfMaxResultsCutoff,mt:IfMoreResults,mt:IfNeedEmail,mt:IfNonEmpty,mt:IfNonZero,mt:IfPingsAccepted,mt:IfPingsActive,mt:IfPingsAllowed,mt:IfPingsModerated,mt:IfPreviousResults,mt:IfRegistrationAllowed,mt:IfRegistrationNotRequired,mt:IfRegistrationRequired,mt:IfRequireCommentEmails,mt:IfStatic,mt:IfStraightSearch,mt:IfTagSearch,mt:IfTypeKeyToken,mt:IfWebsite,mt:Ignore,mt:ImageCustomFields,mt:IncludeBlock,mt:IndexList,mt:Loop,mt:MarkdownOptions,mt:MultiBlog,mt:MultiBlogIfLocalBlog,mt:MultiBlogLocalBlog,mt:NoSearch,mt:NoSearchResults,mt:OtherBlog,mt:OtherProfiles,mt:PageAssets,mt:PageCustomFields,mt:PageFolder,mt:PageIfTagged,mt:PageNext,mt:PagePrevious,mt:PageTags,mt:PagerBlock,mt:Pages,mt:PagesFooter,mt:PagesHeader,mt:ParentCategories,mt:ParentCategory,mt:ParentFolder,mt:ParentFolders,mt:PingEntry,mt:Pings,mt:PingsFooter,mt:PingsHeader,mt:PingsSent,mt:ProfileServices,mt:SearchResults,mt:Section,mt:SetHashVar,mt:SetVarBlock,mt:SetVarTemplate,mt:SetVars,mt:StreamActionRollup,mt:StreamActionTags,mt:SubCatIsFirst,mt:SubCatIsLast,mt:SubCategories,mt:SubFolders,mt:Tags,mt:TemplateCustomFields,mt:Textile,mt:TopLevelCategories,mt:TopLevelFolder,mt:TopLevelFolders,mt:TopLevelParent,mt:Unless,mt:VideoCustomFields,mt:WebsiteCustomFields,mt:WebsiteIfCCLicense,mt:WebsiteIfCommentsOpen,mt:Websites',
			'inline_level': 'a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var,mt:AdminCGIPath,mt:AdminScript,mt:App:ActionBar,mt:App:Link,mt:App:ListFilters,mt:App:PageActions,mt:ArchiveCategory,mt:ArchiveCount,mt:ArchiveDate,mt:ArchiveDateEnd,mt:ArchiveFile,mt:ArchiveLabel,mt:ArchiveLink,mt:ArchiveTitle,mt:ArchiveType,mt:ArchiveTypeLabel,mt:AssetAddedBy,mt:AssetCount,mt:AssetDateAdded,mt:AssetDescription,mt:AssetFileExt,mt:AssetFileName,mt:AssetFilePath,mt:AssetID,mt:AssetLabel,mt:AssetLink,mt:AssetMimeType,mt:AssetProperty,mt:AssetRank,mt:AssetScore,mt:AssetScoreAvg,mt:AssetScoreCount,mt:AssetScoreHigh,mt:AssetScoreLow,mt:AssetThumbnailLink,mt:AssetThumbnailURL,mt:AssetType,mt:AssetURL,mt:AtomScript,mt:AudioCustomFieldDescription,mt:AudioCustomFieldName,mt:AudioCustomFieldValue,mt:AuthorAuthIconURL,mt:AuthorAuthType,mt:AuthorBasename,mt:AuthorCommentCount,mt:AuthorCustomFieldDescription,mt:AuthorCustomFieldName,mt:AuthorCustomFieldValue,mt:AuthorDisplayName,mt:AuthorEmail,mt:AuthorEntriesCount,mt:AuthorEntryCount,mt:AuthorFollowLink,mt:AuthorFollowersCount,mt:AuthorFollowingCount,mt:AuthorID,mt:AuthorName,mt:AuthorRank,mt:AuthorScore,mt:AuthorScoreAvg,mt:AuthorScoreCount,mt:AuthorScoreHigh,mt:AuthorScoreLow,mt:AuthorURL,mt:AuthorUnFollowLink,mt:AuthorUserpic,mt:AuthorUserpicURL,mt:BlogArchiveURL,mt:BlogCCLicenseImage,mt:BlogCCLicenseURL,mt:BlogCategoryCount,mt:BlogCommentCount,mt:BlogCustomFieldDescription,mt:BlogCustomFieldName,mt:BlogCustomFieldValue,mt:BlogDescription,mt:BlogEntryCount,mt:BlogFileExtension,mt:BlogHost,mt:BlogID,mt:BlogLanguage,mt:BlogName,mt:BlogPageCount,mt:BlogPingCount,mt:BlogRelativeURL,mt:BlogSitePath,mt:BlogTemplateSetID,mt:BlogThemeID,mt:BlogTimezone,mt:BlogURL,mt:BuildTemplateID,mt:CCLicenseRDF,mt:CGIHost,mt:CGIPath,mt:CGIRelativeURL,mt:CGIServerPath,mt:CalendarCellNumber,mt:CalendarDate,mt:CalendarDay,mt:CaptchaFields,mt:CategoryArchiveLink,mt:CategoryBasename,mt:CategoryCommentCount,mt:CategoryCount,mt:CategoryCustomFieldDescription,mt:CategoryCustomFieldName,mt:CategoryCustomFieldValue,mt:CategoryCustomFields,mt:CategoryDescription,mt:CategoryID,mt:CategoryLabel,mt:CategoryTrackbackCount,mt:CategoryTrackbackLink,mt:CommentAuthor,mt:CommentAuthorIdentity,mt:CommentAuthorLink,mt:CommentBlogID,mt:CommentBody,mt:CommentCustomFieldDescription,mt:CommentCustomFieldName,mt:CommentCustomFieldValue,mt:CommentDate,mt:CommentEmail,mt:CommentEntryID,mt:CommentID,mt:CommentIP,mt:CommentLink,mt:CommentName,mt:CommentOrderNumber,mt:CommentParentID,mt:CommentPreviewAuthor,mt:CommentPreviewAuthorLink,mt:CommentPreviewBody,mt:CommentPreviewDate,mt:CommentPreviewEmail,mt:CommentPreviewIP,mt:CommentPreviewIsStatic,mt:CommentPreviewURL,mt:CommentRank,mt:CommentRepliesRecurse,mt:CommentScore,mt:CommentScoreAvg,mt:CommentScoreCount,mt:CommentScoreHigh,mt:CommentScoreLow,mt:CommentScript,mt:CommentURL,mt:CommenterAuthIconURL,mt:CommenterAuthType,mt:CommenterEmail,mt:CommenterID,mt:CommenterName,mt:CommenterNameThunk,mt:CommenterURL,mt:CommenterUsername,mt:CommenterUserpic,mt:CommenterUserpicURL,mt:CommunityScript,mt:ConfigFile,mt:CurrentPage,mt:CustomFieldBasename,mt:CustomFieldDescription,mt:CustomFieldHTML,mt:CustomFieldIsRequired,mt:CustomFieldName,mt:CustomFieldValue,mt:Date,mt:DefaultLanguage,mt:EntriesCount,mt:EntryAtomID,mt:EntryAudio,mt:EntryAuthor,mt:EntryAuthorDisplayName,mt:EntryAuthorEmail,mt:EntryAuthorID,mt:EntryAuthorLink,mt:EntryAuthorNickname,mt:EntryAuthorURL,mt:EntryAuthorUsername,mt:EntryAuthorUserpic,mt:EntryAuthorUserpicURL,mt:EntryBasename,mt:EntryBlogDescription,mt:EntryBlogID,mt:EntryBlogName,mt:EntryBlogURL,mt:EntryBody,mt:EntryCategory,mt:EntryClass,mt:EntryClassLabel,mt:EntryCommentCount,mt:EntryCreatedDate,mt:EntryCustomFieldDescription,mt:EntryCustomFieldName,mt:EntryCustomFieldValue,mt:EntryDate,mt:EntryEditLink,mt:EntryEmbedCode,mt:EntryExcerpt,mt:EntryFlag,mt:EntryID,mt:EntryKeywords,mt:EntryLink,mt:EntryLinkURL,mt:EntryModifiedDate,mt:EntryMore,mt:EntryPermalink,mt:EntryPhoto,mt:EntryPostType,mt:EntryRank,mt:EntryRawPostType,mt:EntryRecommendVoteLink,mt:EntryRecommendedTotal,mt:EntryScore,mt:EntryScoreAvg,mt:EntryScoreCount,mt:EntryScoreHigh,mt:EntryScoreLow,mt:EntryStatus,mt:EntryTitle,mt:EntryTrackbackCount,mt:EntryTrackbackData,mt:EntryTrackbackID,mt:EntryTrackbackLink,mt:ErrorMessage,mt:FeedEntryLink,mt:FeedEntryTitle,mt:FeedInclude,mt:FeedLink,mt:FeedTitle,mt:FeedbackScore,mt:FileCustomFieldName,mt:FileCustomFieldValue,mt:FileTemplate,mt:FolderBasename,mt:FolderCount,mt:FolderCustomFieldDescription,mt:FolderCustomFieldName,mt:FolderCustomFieldValue,mt:FolderDescription,mt:FolderID,mt:FolderLabel,mt:FolderPath,mt:GetVar,mt:HTTPContentType,mt:IfEntryRecommended,mt:ImageCustomFieldDescription,mt:ImageCustomFieldName,mt:ImageCustomFieldValue,mt:ImageHeight,mt:ImageURL,mt:ImageWidth,mt:Include,mt:IndexBasename,mt:IndexLink,mt:IndexName,mt:Link,mt:MaxResults,mt:NextLink,mt:NotifyScript,mt:OtherProfileVar,mt:PageAuthorDisplayName,mt:PageAuthorEmail,mt:PageAuthorLink,mt:PageAuthorURL,mt:PageBasename,mt:PageBody,mt:PageCustomFieldDescription,mt:PageCustomFieldName,mt:PageCustomFieldValue,mt:PageDate,mt:PageExcerpt,mt:PageID,mt:PageKeywords,mt:PageModifiedDate,mt:PageMore,mt:PagePermalink,mt:PageTitle,mt:PagerLink,mt:PingBlogName,mt:PingDate,mt:PingExcerpt,mt:PingID,mt:PingIP,mt:PingRank,mt:PingScore,mt:PingScoreAvg,mt:PingScoreCount,mt:PingScoreHigh,mt:PingScoreLow,mt:PingTitle,mt:PingURL,mt:PingsSentURL,mt:PreviousLink,mt:ProductName,mt:PublishCharset,mt:RemoteSignInLink,mt:RemoteSignOutLink,mt:SearchIncludeBlogs,mt:SearchMaxResults,mt:SearchResultCount,mt:SearchScript,mt:SearchString,mt:SearchTemplateID,mt:SetVar,mt:SignOnURL,mt:SmartyPantsVersion,mt:StaticFilePath,mt:StaticWebPath,mt:StreamAction,mt:StreamActionDate,mt:StreamActionID,mt:StreamActionModifiedDate,mt:StreamActionThumbnailURL,mt:StreamActionTitle,mt:StreamActionVar,mt:StreamActionVia,mt:SubCategoryPath,mt:SubCatsRecurse,mt:SubFolderRecurse,mt:SupportDirectoryURL,mt:TagCount,mt:TagID,mt:TagLabel,mt:TagName,mt:TagRank,mt:TagSearchLink,mt:TemplateCreatedOn,mt:TemplateCustomFieldDescription,mt:TemplateCustomFieldName,mt:TemplateCustomFieldValue,mt:TemplateNote,mt:TextileHeadOffset,mt:TextileOptions,mt:TotalPages,mt:TrackbackScript,mt:TypeKeyToken,mt:Var,mt:Version,mt:VideoCustomFieldDescription,mt:VideoCustomFieldName,mt:VideoCustomFieldValue,mt:WebsiteCCLicenseImage,mt:WebsiteCCLicenseURL,mt:WebsiteCommentCount,mt:WebsiteCustomFieldDescription,mt:WebsiteCustomFieldName,mt:WebsiteCustomFieldValue,mt:WebsiteDescription,mt:WebsiteFileExtension,mt:WebsiteHost,mt:WebsiteID,mt:WebsiteLanguage,mt:WebsiteName,mt:WebsitePageCount,mt:WebsitePath,mt:WebsitePingCount,mt:WebsiteRelativeURL,mt:WebsiteThemeID,mt:WebsiteTimezone,mt:WebsiteURL,mt:WidgetManager,mt:WidgetSet,mt:XMLRPCScript'
		}
	},
